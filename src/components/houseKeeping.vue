<template>
	<div>
		<nav style="width:100%;height:50px;box-shadow:0px 2px 4px rgba(0,0,0,0.6);position:fixed;top:0;background-color:white;">
			<h6 style="margin-top:13px;" >
				...
				<span style="margin-left:20px;font-size:22px;font-family:Montserrat;font-weight:600;"> House- Keeping</span></h6>
			</nav>
	...
	export default {
		...
		mounted(){
  		...
  		firebase.firestore().collection('housekeeping').doc("OwnerId").get().then( res =>{
